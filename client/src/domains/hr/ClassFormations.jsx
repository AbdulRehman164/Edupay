...
function ClassFormations() {
    ...
    async function searchBatches(search = '') {
        ...
        try {
            const res = await fetch(`/api/hr/formations?search=${search}`);
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-6 bg-white rounded-xl border border-gray-200 overflow-hidden mt-10">
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {batches.map((b) => (
                                    ...
                                    >
                                        ...
                                        <td>
                                            <DownloadClassFormationButton
                                                id={b.id}
                                                isDisabled={
                                                    b.formation_finalized ==
                                                    false
                                                }
                                            />
                                        </td>
...
export default ClassFormations;
